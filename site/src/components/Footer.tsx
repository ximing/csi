    ...
    <footer className="footer">
      <div className="container footer-inner">
        ...
        <div className="footer-links">
          ...
          <a href={lang === 'zh' ? 'https://github.com/ximing/csi/blob/master/README.md' : 'https://github.com/ximing/csi/blob/master/README.en.md'} target="_blank" rel="noreferrer">{t.footer.readme}</a>
